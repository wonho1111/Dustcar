...
// This ISR handles button presses on the user button on the board. 
// This will toggle the motors on/off
CY_ISR(swisr)
{
    motorFlag = 1;
...
// Configure the speed into the correct PWM, 
// then call the GATT database speed update function
